<?php?><?php
        ...
        function insertReview()
        {
          if (!empty($_GET['name']) && !empty($_GET['comment'])) {
            $insert = new insert($_GET['name'], $_GET['comment']);
        ...
        function deleteT()
        {
          if (!empty($_GET['delete'])) {
            ...
            <strong>Error Feedback Not delete!</strong>
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
              </button>
              </div>';
        ...
        function editT()
        {
          if (!empty($_GET['edit'])) {
            ...
            if ($edit->editTask()) {
              ...
              <strong>Feedback is posted successfully!</strong>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
                </div>';
              ...
              echo '<div class="col-md-9 alert alert-Danger alert-dismissible fade show" role="alert">
              <strong>Error Feedback Not edited!</strong>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
